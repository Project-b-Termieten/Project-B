...
public class Program
{
    ...
    public static void Main()
    {
        while (true)
        {
            ...
            switch (userInput)
            {
                case "1":
                    ...
                    {
                        Console.WriteLine("Do you want to make(1) a reservation OR remove(2) a reservation");
                        ...
                        {
                            Reserve.CancelReservation(currentUser.Name, currentUser.Email);
        ...
        static void Remove_or_Add()
        {
            Console.WriteLine("Do you want to  make a reservation or remove reservation");
        ...
        static void login_or_Signup()
        {
            ...
            else if (user_answer == "2")
            {
                ...
                Console.WriteLine("Please enter a password that needs to be 8 charachter long: ");
