...
public static class Menu
{
    ...
    static public void Display_menu()
    {
        ...
        Console.WriteLine("-----------------------------");
        string json = File.ReadAllText("C:\\Users\\jerre\\OneDrive\\Bureaublad\\projectbb\\projectbb\\Menu_Food.json");
        ...
        Console.WriteLine("-----------------------------");
        string json_ = File.ReadAllText("C:\\Users\\jerre\\OneDrive\\Bureaublad\\projectbb\\projectbb\\Menu_Drink.json");
    ...
    static public void Add_food(Food Food_item)
    {
        ...
        File.WriteAllText(@"C:\Users\jerre\OneDrive\Bureaublad\projectbb\projectbb\Menu_Food.json", updatedJson);
    }

    static public void Add_drink(Drink Drink_item)
    {
        // Deserialize the existing data from the JSON file
        string json = File.ReadAllText("C:\\Users\\jerre\\OneDrive\\Bureaublad\\projectbb\\projectbb\\Menu_Drink.json");
        ...
        File.WriteAllText("C:\\Users\\jerre\\OneDrive\\Bureaublad\\projectbb\\projectbb\\Menu_Drink.json", updatedJson);
    }
